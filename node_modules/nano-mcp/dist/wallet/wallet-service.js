...
class WalletService {
    constructor() {
        ...
        this.logger = new logger_1.Logger(path_1.default.join(__dirname, 'logs'));
        this.keyManager = new key_manager_1.KeyManager(this.logger);
    }
        ...
        try {
            ...
            for (const blockHash of Object.keys(pendingData.blocks)) {
                try {
                    ...
                    const signedBlock = nanocurrency_web_1.block.receive(blockData, privateKey);
